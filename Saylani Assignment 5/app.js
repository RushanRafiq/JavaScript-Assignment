...
alert(pizza)
    //task6
var Email = "rushanrafiq99@gmail.com"
...
var empty = []
    //task2
    //task3
var stringarray = ["rushan", "sarim", "umar"]
    //task4
var numarray = [2, 3, 2, 4]
    //task5
var booleanarray = [true, false]
    //task6
var mixearray = ["rushan", 5, "+", true]
    //task7
...
document.write("<h4>Qualifications</h4>", edu[0], "<br>", edu[1], "<br>", edu[2], "<br>", edu[3], "<br>", edu[4], "<br>", edu[5], "<br>", edu[6])
    //task8
var studentarray = ["rushan", "sheroze", "umar"]
